...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#060b14] relative" dir="rtl">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="px-6 lg:px-12 pt-5 pb-0 flex items-center justify-between border-b border-white/5">
          ...
          <div className="flex flex-col items-center justify-center gap-1 md:gap-2 pb-5 pt-2 md:mr-2 xl:mr-2">
            ...
            <div className="h-[1.5px] w-20 md:w-28 bg-primary rounded-full opacity-80 mt-4 md:mt-5 mb-1"></div>
            ...
            {rootCategories.map((cat: any) => {
              ...
              return (
                <div key={cat.slug || cat.name_ar} className="relative group h-full flex items-center">
                  ...
                  {hasSub && (
                    <div className="absolute top-full right-0 min-w-[180px] bg-[#060b14] border border-white/5 border-t-0 rounded-b-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 flex flex-col py-2 z-50">
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden bg-[#060b14] border-t border-white/5 flex flex-col px-6 py-4 space-y-4 overflow-hidden"
            >
