...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#0c1220] relative" dir="rtl">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="px-6 lg:px-12 pt-5 pb-0 flex items-center justify-between border-b border-white/5">
          ...
          <div className="flex flex-col items-center justify-center gap-1 md:gap-2 pb-5 pt-2 md:mr-2 xl:mr-2">
            ...
            <div className="h-[1.5px] w-16 md:w-24 bg-primary rounded-full opacity-80 mt-2 md:mt-3 mb-1"></div>
            <span className="text-slate-400 text-[9px] md:text-[11px] font-medium tracking-[0.2em] whitespace-nowrap">صحيفة إلكترونية مستقلة</span>
          </div>
